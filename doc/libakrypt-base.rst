...
а также почтовых вложений, кодируемых 64-мя символами:
...
В случае необходимости использования кодировки **base64** для других целей,
...
Пример использования указанных функций приводится далее (файл ``example-g02n04.c``).
